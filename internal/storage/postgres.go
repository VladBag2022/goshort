...
func NewPostgresRepository(
	...
	insertURLStmt, err := db.PrepareContext(ctx, "INSERT INTO shortened_urls (id, url) VALUES ($1, $2)")
	if err != nil {
		return nil, err
	}
	bindStmt, err := db.PrepareContext(ctx, "INSERT INTO users_url_m2m (user_id, url_id) VALUES ($1, $2)")
	if err != nil {
		return nil, err
	}
